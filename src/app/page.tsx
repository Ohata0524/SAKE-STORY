...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-gray-50 pb-20">
      ...
      <header className="bg-white sticky top-0 z-10 shadow-sm p-5">
        <div className="w-full max-w-6xl mx-auto flex justify-between items-center">
          <h1 className="text-3xl font-serif font-bold text-blue-900 tracking-wide">SAKE STORY</h1>
          <Link href="/mypage"><User size={28} className="text-gray-600 hover:text-blue-900 transition" /></Link>
        </div>
      </header>

      <div className="w-full max-w-6xl mx-auto px-6 mt-8">
        <section className="rounded-[2rem] bg-gradient-to-br from-indigo-500 to-purple-600 text-white p-12 md:p-20 text-center shadow-xl">
        ...
        <section className="mt-16">
          <h3 className="text-2xl font-bold text-gray-800 border-l-8 border-indigo-500 pl-4 mb-6">テーマで探す</h3>
        ...
        <section className="mt-16">
          <h3 className="text-2xl font-bold text-gray-800 border-l-8 border-indigo-500 pl-4 mb-8">今月のおすすめ</h3>
        ...
        <section className="mt-20">
          <Link href="/list" className="group block w-full bg-white border-4 border-dashed border-indigo-100 rounded-[2rem] p-12 text-center hover:border-indigo-400 transition">
            <h3 className="text-2xl font-bold text-indigo-900 mb-6">あなただけの一本を見つける</h3>
            <span className="inline-flex items-center gap-3 bg-indigo-900 text-white px-10 py-4 rounded-full font-bold shadow-lg group-hover:bg-indigo-700 transition">
